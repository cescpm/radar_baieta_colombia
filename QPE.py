...
variables = [
    "UH", "UV", "DBZH", "DBZV", "ZDR", "RHOHV", "PHIDP", "KDP", 
    "NCPH", "NCPV", "SNRHC", "SNRVC", "VELH", "VELV", "WIDTHH", 
    "WIDTHV", "CCORH", "CCORV", "HMC", "cKDP", "cPHIDP", "alpha", 
    "PIA", "cDBZH", "A_kdp", "R_A"
]
...
for i,var in enumerate(variables):
    ...
    ax = fig.add_subplot(
        ...
        n_cols,
        i+1,
        projection=ccrs.AzimuthalEquidistant(central_longitude=da.longitude.values, central_latitude=da.latitude.values),
    )
